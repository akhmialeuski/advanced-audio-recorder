...
| **Speaker diarization**  | Transcription section                  | Speaker labels, available on Deepgram, Gemini, and Mistral Voxtral and greyed out for Whisper API and local `whisper.cpp`. |
