...
| Quick notes       | `quicknotes/` (`QuickNoteController`)                                                                                                                                              | Dictation inserted at the cursor: sequences the in-memory capture, the dictation run of `TranscriptionService`, and the note inserter, and owns the state the quick note ribbon button shows. The audio is never written to the vault.                                                                                                                                                                                                                                   |
