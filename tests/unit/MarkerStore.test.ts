...
/** Builds a MarkerStore over its own fresh shared sidecar store. */
function makeStore(app: App): MarkerStore {
	return new MarkerStore(new RecordingSidecarStore(app));
}
